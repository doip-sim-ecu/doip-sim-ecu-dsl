...
class DoipMessageParserTest {
    ...
    fun test() {
        ...
        val negAck = DoipMessageParser.parseUDP(negAckMsg)
        ...
        val virVIN = DoipMessageParser.parseUDP(virVINMsg)
        ...
        val vam = DoipMessageParser.parseUDP(vamMsg)
        assertIs<DoipUdpVehicleVehicleAnnouncmentMessage>(vam)
        ...
        val esReq = DoipMessageParser.parseUDP(esReqMsg)
        ...
        val esRes = DoipMessageParser.parseUDP(esResMsg)
        ...
        val pmReq = DoipMessageParser.parseUDP(pmReqMsg)
        ...
        val pmRes = DoipMessageParser.parseUDP(pmResMsg)
